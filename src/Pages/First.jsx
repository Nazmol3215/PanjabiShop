...
import gfh from '../Images/451-300x386.jpg';
import gfh1 from '../Images/457-300x386.jpg';
import gfh3 from '../Images/469-300x386.jpg';
import gfh4 from '../Images/719-300x386.jpg';
...
const ProductCardsFirst = () => {
  ...
  return (
    <div className="container my-5">
      <h2 className="text-center text-success mb-4">সর্বশেষ কালেকশন</h2>
